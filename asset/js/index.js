...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    function endQuiz() {
        ...
        const incorrectOffset = circumference - correctOffset;

        // Nascondi il quiz container e mostra i risultati
        document.getElementById('quiz-container').style.display = 'none';
        document.getElementById('timer-container').style.display = 'none';
        const resultsScreen = document.getElementById('results-screen');
        resultsScreen.style.display = 'flex'; // Cambia questo con 'block' o altro a seconda del tuo CSS
        ...
        <div id="details-container" class="details-container">
            ...
            <svg width="200" height="200" viewBox="0 0 200 200">
                ...
                <circle r="90" cx="100" cy="100" fill="transparent" stroke="#d20094" stroke-width="20"
                        stroke-dasharray="${circumference}" stroke-dashoffset="${incorrectOffset}"
                        transform="rotate(${correctOffset / circumference * 360 - 90} 100 100)" />
            </svg>
        ...
        <form action="./rating.html">
            <button class="cursore" id="proceed" type="text">PROCEED</button>
        </form>
    `;
    }
